...
class LorawanMacHelper
{
  public:
     ...
     * SF12 -> DR0
     */
    static std::vector<int> SetSpreadingFactorsUp(const string& filePath, int NDevices, int radius, const string& model_name,NodeContainer endDevices,
    ...
    /*static void readPredictedSFResult(const string& filePath, int NDevices, int radius, const string& model_name,NodeContainer endDevices,
                                        NodeContainer gateways,
